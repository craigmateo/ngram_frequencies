...
colnames = ['year','AVG']
data = pd.read_csv("ngram_BR_normalized1850_1920.csv", names=colnames)
...
colnames_pop = ["YEAR","PERCENT_URBAN","PERCENT_RURAL","NORMALIZED"]
data_pop = pd.read_csv("rural_pop_BR1850_1920.csv", names=colnames_pop)
...
plt.legend(['Frequency (Google Books)', 'Rural Population'], loc='upper left')
...
#plt.scatter(x_inter,y_inter,color='#003F72')
plt.plot(x_inter, regression_line)
