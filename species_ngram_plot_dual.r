...
plot(x = input1$year,y = input1$AVG, pch=16, axes=FALSE, ylim=c(0.2,1.6), xlim=c(1800,2000), xlab="Year", ylab="Frequency", type="b",col="black", main="Frequency and Rural Pop.")
